  ...
  return (<>
    <div className="datenschutz-page">
      ...
      <div id="ContainerDIV">
        ...
        <section className="section data-collection">
        ...
        <section className="section purposes">
          ...
          <p className="DataProtectionParagraphs">Wir verarbeiten Ihre personenbezogenen Daten zu folgenden Zwecken:</p>
        ...
        <section className="section legal-basis">
        ...
        <section className="section data-sharing">
        ...
        <section className="section rights">
        ...
        <section className="section data-security">
